...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://hassane008:12345678cluster@cluster0.ulwy4is.mongodb.net/?retryWrites=true&w=majority";
...
global.devs = "237686931816";
global.sudo = process.env.SUDO || "237686931816";
global.owner = process.env.OWNER_NUMBER || "237686931816";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "꧁❤•༆$ℌѦℌѦℌѦ(｡♥‿♥｡)",
  packname: process.env.PACK_NAME || "꧁❤•༆$ℌѦℌѦℌѦ(｡♥‿♥｡)",
  botname: process.env.BOT_NAME || "hassane",
  ownername: process.env.OWNER_NAME || "hassane",
  errorChat: process.env.ERROR_CHAT || "923192173398",
  KOYEB_API: process.env.KOYEB_API || "false",
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "hassane",
